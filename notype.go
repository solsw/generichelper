...
// NoType is a sentinel type to denote that this [type parameter] needs not to be processed
// (see ExampleNoType).
// NoType may be used to [instantiate] [type parameter] with 'any' [type constraint] only.
//
